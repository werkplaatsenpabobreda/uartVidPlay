...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("UartVidPlay", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("UartVidPlay", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "Avans";
		app.meta["file"] = "UartVidPlay";
		app.meta["name"] = "UartVidPlay";
		app.meta["packageName"] = "nl.avans.uartvidplay";

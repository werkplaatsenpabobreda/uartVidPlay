...
HX_LOCAL_STACK_FRAME(_hx_pos_39f5eab4124248fe_67_putEnv,"Sys","putEnv",0xa97fddbf,"Sys.putEnv","/usr/local/lib/haxe/std/cpp/_std/Sys.hx",67,0xd23c22f3)
...
void Sys_obj::putEnv(::String s,::String v){
            	HX_STACKFRAME(&_hx_pos_39f5eab4124248fe_67_putEnv)

...
HXLINE(  76)		{
HXLINE(  76)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/libvlc.json",6e,60,b6,a2));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("libvlc",48,b2,be,e4),v);
            		}
HXLINE(  77)		{
HXLINE(  77)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  77)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v1);
            		}
...
HXLINE(  82)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}

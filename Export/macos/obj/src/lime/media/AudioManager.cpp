...
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_53_init,"lime.media.AudioManager","init",0x83630824,"lime.media.AudioManager.init","lime/media/AudioManager.hx",53,0x63af6ea2)
...
HXDLIN(  24)		if (::hx::IsNull( ::lime::media::AudioManager_obj::context )) {
            			...
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_b537b97081e2aab9_53_init)
HXLINE(  53)				::lime::_internal::backend::native::NativeCFFI_obj::lime_al_cleanup();
            			}
...
HXLINE(  50)			 ::haxe::Timer timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(100) ));
HXLINE(  51)			timer->run =  ::Dynamic(new _hx_Closure_0());
            		}
            	}

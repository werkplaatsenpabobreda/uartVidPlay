...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1637___fromImageBuffer,"lime.graphics.Image","__fromImageBuffer",0xe152fb34,"lime.graphics.Image.__fromImageBuffer","lime/graphics/Image.hx",1637,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1689_get_data,"lime.graphics.Image","get_data",0x7986ad30,"lime.graphics.Image.get_data","lime/graphics/Image.hx",1689,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1705_set_data,"lime.graphics.Image","set_data",0x27e406a4,"lime.graphics.Image.set_data","lime/graphics/Image.hx",1705,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1710_get_format,"lime.graphics.Image","get_format",0xc57a33bd,"lime.graphics.Image.get_format","lime/graphics/Image.hx",1710,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1714_set_format,"lime.graphics.Image","set_format",0xc8f7d231,"lime.graphics.Image.set_format","lime/graphics/Image.hx",1714,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1731_get_powerOfTwo,"lime.graphics.Image","get_powerOfTwo",0x62ee1df6,"lime.graphics.Image.get_powerOfTwo","lime/graphics/Image.hx",1731,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1737_set_powerOfTwo,"lime.graphics.Image","set_powerOfTwo",0x830e066a,"lime.graphics.Image.set_powerOfTwo","lime/graphics/Image.hx",1737,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1788_get_premultiplied,"lime.graphics.Image","get_premultiplied",0xc1478990,"lime.graphics.Image.get_premultiplied","lime/graphics/Image.hx",1788,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1792_set_premultiplied,"lime.graphics.Image","set_premultiplied",0xe4b5619c,"lime.graphics.Image.set_premultiplied","lime/graphics/Image.hx",1792,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1829_get_rect,"lime.graphics.Image","get_rect",0x82caa42a,"lime.graphics.Image.get_rect","lime/graphics/Image.hx",1829,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1841_get_src,"lime.graphics.Image","get_src",0x66c2929e,"lime.graphics.Image.get_src","lime/graphics/Image.hx",1841,0xc7b862ad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1850_get_transparent,"lime.graphics.Image","get_transparent",0xe1ee610c,"lime.graphics.Image.get_transparent","lime/graphics/Image.hx",1850,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1856_set_transparent,"lime.graphics.Image","set_transparent",0xddb9de18,"lime.graphics.Image.set_transparent","lime/graphics/Image.hx",1856,0xc7b862ad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1655___isGIF,"lime.graphics.Image","__isGIF",0x6ba10e3d,"lime.graphics.Image.__isGIF","lime/graphics/Image.hx",1655,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1663___isJPG,"lime.graphics.Image","__isJPG",0x6ba35b1a,"lime.graphics.Image.__isJPG","lime/graphics/Image.hx",1663,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1673___isPNG,"lime.graphics.Image","__isPNG",0x6ba7e6e2,"lime.graphics.Image.__isPNG","lime/graphics/Image.hx",1673,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1681___isWebP,"lime.graphics.Image","__isWebP",0xcbf428e3,"lime.graphics.Image.__isWebP","lime/graphics/Image.hx",1681,0xc7b862ad)
namespace lime{
namespace graphics{
...
HXLINE(1618)		if (::hx::IsNotNull( buffer )) {
HXLINE(1620)			this->_hx___fromImageBuffer(buffer);
HXLINE(1622)			if (::hx::IsNotNull( onload )) {
HXLINE(1624)				onload(::hx::ObjectPtr<OBJ_>(this));
            			}
...
void Image_obj::_hx___fromImageBuffer( ::lime::graphics::ImageBuffer buffer){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1637___fromImageBuffer)
HXLINE(1638)		this->buffer = buffer;
HXLINE(1640)		if (::hx::IsNotNull( buffer )) {
HXLINE(1642)			if ((this->width == -1)) {
HXLINE(1644)				this->width = buffer->width;
            			}
HXLINE(1647)			if ((this->height == -1)) {
HXLINE(1649)				this->height = buffer->height;
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Image_obj,_hx___fromImageBuffer,(void))
 ...
 ::lime::utils::ArrayBufferView Image_obj::get_data(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1689_get_data)
HXLINE(1690)		bool _hx_tmp;
HXDLIN(1690)		bool _hx_tmp1;
HXDLIN(1690)		if (::hx::IsNull( this->buffer->data )) {
HXLINE(1690)			_hx_tmp1 = (this->buffer->width > 0);
            		}
            		else {
HXLINE(1690)			_hx_tmp1 = false;
            		}
HXDLIN(1690)		if (_hx_tmp1) {
HXLINE(1690)			_hx_tmp = (this->buffer->height > 0);
            		}
            		else {
HXLINE(1690)			_hx_tmp = false;
            		}
HXLINE(1700)		return this->buffer->data;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_data,return )
 ...
 ::lime::utils::ArrayBufferView Image_obj::set_data( ::lime::utils::ArrayBufferView value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1705_set_data)
HXDLIN(1705)		return (this->buffer->data = value);
            	}
...
int Image_obj::get_format(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1710_get_format)
HXDLIN(1710)		return this->buffer->format;
            	}
...
int Image_obj::set_format(int value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1714_set_format)
HXLINE(1715)		if ((this->buffer->format != value)) {
HXLINE(1717)			if ((this->type->_hx_getIndex() == 1)) {
HXLINE(1720)				::lime::_internal::graphics::ImageDataUtil_obj::setFormat(::hx::ObjectPtr<OBJ_>(this),value);
            			}
            		}
HXLINE(1726)		return (this->buffer->format = value);
            	}
...
bool Image_obj::get_powerOfTwo(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1731_get_powerOfTwo)
HXDLIN(1731)		bool _hx_tmp;
HXDLIN(1731)		if ((this->buffer->width != 0)) {
HXDLIN(1731)			_hx_tmp = ((this->buffer->width & (~(this->buffer->width) + 1)) == this->buffer->width);
            		}
            		else {
HXDLIN(1731)			_hx_tmp = false;
            		}
HXDLIN(1731)		if (_hx_tmp) {
HXLINE(1733)			if ((this->buffer->height != 0)) {
HXLINE(1733)				return ((this->buffer->height & (~(this->buffer->height) + 1)) == this->buffer->height);
            			}
            			else {
...
bool Image_obj::set_powerOfTwo(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1737_set_powerOfTwo)
HXLINE(1738)		if ((value != this->get_powerOfTwo())) {
HXLINE(1740)			int newWidth = 1;
HXLINE(1741)			int newHeight = 1;
HXLINE(1743)			while((newWidth < this->buffer->width)){
HXLINE(1745)				newWidth = (newWidth << 1);
            			}
HXLINE(1748)			while((newHeight < this->buffer->height)){
HXLINE(1750)				newHeight = (newHeight << 1);
            			}
HXLINE(1753)			bool _hx_tmp;
HXDLIN(1753)			if ((newWidth == this->buffer->width)) {
HXLINE(1753)				_hx_tmp = (newHeight == this->buffer->height);
            			}
            			else {
HXLINE(1753)				_hx_tmp = false;
            			}
HXDLIN(1753)			if (_hx_tmp) {
HXLINE(1755)				return value;
            			}
HXLINE(1758)			switch((int)(this->type->_hx_getIndex())){
            				case (int)0: {
HXLINE(1764)					::lime::_internal::graphics::ImageDataUtil_obj::resizeBuffer(::hx::ObjectPtr<OBJ_>(this),newWidth,newHeight);
            				}
            				break;
            				case (int)1: {
HXLINE(1767)					::lime::_internal::graphics::ImageDataUtil_obj::resizeBuffer(::hx::ObjectPtr<OBJ_>(this),newWidth,newHeight);
            				}
            				break;
            				case (int)2: {
            				}
...
bool Image_obj::get_premultiplied(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1788_get_premultiplied)
HXDLIN(1788)		return this->buffer->premultiplied;
            	}
...
bool Image_obj::set_premultiplied(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1792_set_premultiplied)
HXLINE(1793)		bool _hx_tmp;
HXDLIN(1793)		if (value) {
HXLINE(1793)			_hx_tmp = !(this->buffer->premultiplied);
            		}
            		else {
HXLINE(1793)			_hx_tmp = false;
            		}
HXDLIN(1793)		if (_hx_tmp) {
HXLINE(1795)			switch((int)(this->type->_hx_getIndex())){
            				case (int)0: case (int)1: {
HXLINE(1802)					::lime::_internal::graphics::ImageDataUtil_obj::multiplyAlpha(::hx::ObjectPtr<OBJ_>(this));
            				}
            				break;
            				default:{
            				}
...
HXDLIN(1808)			if (!(value)) {
HXLINE(1808)				_hx_tmp1 = this->buffer->premultiplied;
            			}
            			else {
HXLINE(1808)				_hx_tmp1 = false;
            			}
HXDLIN(1808)			if (_hx_tmp1) {
HXLINE(1810)				if ((this->type->_hx_getIndex() == 1)) {
HXLINE(1817)					::lime::_internal::graphics::ImageDataUtil_obj::unmultiplyAlpha(::hx::ObjectPtr<OBJ_>(this));
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Image_obj,set_premultiplied,return )
 ...
 ::lime::math::Rectangle Image_obj::get_rect(){
            	HX_GC_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1829_get_rect)
HXDLIN(1829)		return  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,0,0,this->width,this->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_rect,return )
 ...
 ::Dynamic Image_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1841_get_src)
HXDLIN(1841)		return this->buffer->get_src();
            	}
...
bool Image_obj::get_transparent(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1850_get_transparent)
HXLINE(1851)		if (::hx::IsNull( this->buffer )) {
HXLINE(1851)			return false;
            		}
HXLINE(1852)		return this->buffer->transparent;
            	}
...
bool Image_obj::set_transparent(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1856_set_transparent)
HXLINE(1858)		if (::hx::IsNull( this->buffer )) {
HXLINE(1858)			return false;
            		}
HXLINE(1859)		return (this->buffer->transparent = value);
            	}
...
bool Image_obj::_hx___isGIF( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1655___isGIF)
HXLINE(1656)		bool _hx_tmp;
HXDLIN(1656)		if (::hx::IsNotNull( bytes )) {
HXLINE(1656)			_hx_tmp = (bytes->length < 6);
            		}
            		else {
...
HXLINE(1658)		::String header = bytes->getString(0,6,null());
HXLINE(1659)		if ((header != HX_("GIF87a",1e,95,06,9a))) {
HXLINE(1659)			return (header == HX_("GIF89a",dc,96,06,9a));
            		}
            		else {
HXLINE(1659)			return true;
            		}
HXDLIN(1659)		return false;
            	}
...
bool Image_obj::_hx___isJPG( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1663___isJPG)
HXLINE(1664)		bool _hx_tmp;
HXDLIN(1664)		if (::hx::IsNotNull( bytes )) {
HXLINE(1664)			_hx_tmp = (bytes->length < 4);
            		}
            		else {
...
HXDLIN(1666)		if ((bytes->b->__get(0) == 255)) {
HXLINE(1666)			_hx_tmp2 = (bytes->b->__get(1) == 216);
            		}
            		else {
HXLINE(1666)			_hx_tmp2 = false;
            		}
HXDLIN(1666)		if (_hx_tmp2) {
HXLINE(1666)			_hx_tmp1 = (bytes->b->__get((bytes->length - 2)) == 255);
            		}
            		else {
HXLINE(1666)			_hx_tmp1 = false;
            		}
HXDLIN(1666)		if (_hx_tmp1) {
HXLINE(1669)			return (bytes->b->__get((bytes->length - 1)) == 217);
            		}
            		else {
HXLINE(1666)			return false;
            		}
HXDLIN(1666)		return false;
            	}
...
bool Image_obj::_hx___isPNG( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1673___isPNG)
HXLINE(1674)		bool _hx_tmp;
HXDLIN(1674)		if (::hx::IsNotNull( bytes )) {
HXLINE(1674)			_hx_tmp = (bytes->length < 8);
            		}
            		else {
...
HXLINE(1676)		bool _hx_tmp1;
HXDLIN(1676)		bool _hx_tmp2;
HXDLIN(1676)		bool _hx_tmp3;
HXDLIN(1676)		bool _hx_tmp4;
HXDLIN(1676)		bool _hx_tmp5;
HXDLIN(1676)		bool _hx_tmp6;
HXDLIN(1676)		if ((bytes->b->__get(0) == 137)) {
HXLINE(1676)			_hx_tmp6 = (bytes->b->__get(1) == 80);
            		}
            		else {
HXLINE(1676)			_hx_tmp6 = false;
            		}
HXDLIN(1676)		if (_hx_tmp6) {
HXLINE(1676)			_hx_tmp5 = (bytes->b->__get(2) == 78);
            		}
            		else {
HXLINE(1676)			_hx_tmp5 = false;
            		}
HXDLIN(1676)		if (_hx_tmp5) {
HXLINE(1676)			_hx_tmp4 = (bytes->b->__get(3) == 71);
            		}
            		else {
HXLINE(1676)			_hx_tmp4 = false;
            		}
HXDLIN(1676)		if (_hx_tmp4) {
HXLINE(1676)			_hx_tmp3 = (bytes->b->__get(4) == 13);
            		}
            		else {
HXLINE(1676)			_hx_tmp3 = false;
            		}
HXDLIN(1676)		if (_hx_tmp3) {
HXLINE(1676)			_hx_tmp2 = (bytes->b->__get(5) == 10);
            		}
            		else {
HXLINE(1676)			_hx_tmp2 = false;
            		}
HXDLIN(1676)		if (_hx_tmp2) {
HXLINE(1676)			_hx_tmp1 = (bytes->b->__get(6) == 26);
            		}
            		else {
HXLINE(1676)			_hx_tmp1 = false;
            		}
HXDLIN(1676)		if (_hx_tmp1) {
HXLINE(1677)			return (bytes->b->__get(7) == 10);
            		}
            		else {
HXLINE(1676)			return false;
            		}
HXDLIN(1676)		return false;
            	}
...
bool Image_obj::_hx___isWebP( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1681___isWebP)
HXLINE(1682)		bool _hx_tmp;
HXDLIN(1682)		if (::hx::IsNotNull( bytes )) {
HXLINE(1682)			_hx_tmp = (bytes->length < 16);
            		}
            		else {
...
HXLINE(1684)		if ((bytes->getString(0,4,null()) == HX_("RIFF",b7,20,6b,36))) {
HXLINE(1684)			return (bytes->getString(8,4,null()) == HX_("WEBP",5c,25,b6,39));
            		}
            		else {
HXLINE(1684)			return false;
            		}
HXDLIN(1684)		return false;
            	}

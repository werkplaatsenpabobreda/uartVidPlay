...
HX_DEFINE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_911_new,"lime._internal.backend.native.TouchEventInfo","new",0xc006dded,"lime._internal.backend.native.TouchEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",911,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_924_clone,"lime._internal.backend.native.TouchEventInfo","clone",0xa51e5e2a,"lime._internal.backend.native.TouchEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",924,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void TouchEventInfo_obj::__construct( ::Dynamic type,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id,::hx::Null< Float >  __o_dx,::hx::Null< Float >  __o_dy,::hx::Null< Float >  __o_pressure,::hx::Null< int >  __o_device){
            	...
            	HX_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_911_new)
HXLINE( 912)		this->type = ( (int)(type) );
HXLINE( 913)		this->x = x;
HXLINE( 914)		this->y = y;
HXLINE( 915)		this->id = id;
HXLINE( 916)		this->dx = dx;
HXLINE( 917)		this->dy = dy;
HXLINE( 918)		this->pressure = pressure;
HXLINE( 919)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_924_clone)
HXDLIN( 924)		return  ::lime::_internal::backend::native::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}

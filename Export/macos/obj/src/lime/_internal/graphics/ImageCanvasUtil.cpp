...
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_268_floodFill,"lime._internal.graphics.ImageCanvasUtil","floodFill",0xd8a6edf0,"lime._internal.graphics.ImageCanvasUtil.floodFill","lime/_internal/graphics/ImageCanvasUtil.hx",268,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_275_getPixel,"lime._internal.graphics.ImageCanvasUtil","getPixel",0x812f3261,"lime._internal.graphics.ImageCanvasUtil.getPixel","lime/_internal/graphics/ImageCanvasUtil.hx",275,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_282_getPixel32,"lime._internal.graphics.ImageCanvasUtil","getPixel32",0x91297940,"lime._internal.graphics.ImageCanvasUtil.getPixel32","lime/_internal/graphics/ImageCanvasUtil.hx",282,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_289_getPixels,"lime._internal.graphics.ImageCanvasUtil","getPixels",0x881ce2f2,"lime._internal.graphics.ImageCanvasUtil.getPixels","lime/_internal/graphics/ImageCanvasUtil.hx",289,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_297_merge,"lime._internal.graphics.ImageCanvasUtil","merge",0x56f8d9c7,"lime._internal.graphics.ImageCanvasUtil.merge","lime/_internal/graphics/ImageCanvasUtil.hx",297,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_305_resize,"lime._internal.graphics.ImageCanvasUtil","resize",0xc3395005,"lime._internal.graphics.ImageCanvasUtil.resize","lime/_internal/graphics/ImageCanvasUtil.hx",305,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_330_scroll,"lime._internal.graphics.ImageCanvasUtil","scroll",0x0222ce1e,"lime._internal.graphics.ImageCanvasUtil.scroll","lime/_internal/graphics/ImageCanvasUtil.hx",330,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_345_setPixel,"lime._internal.graphics.ImageCanvasUtil","setPixel",0x2f8c8bd5,"lime._internal.graphics.ImageCanvasUtil.setPixel","lime/_internal/graphics/ImageCanvasUtil.hx",345,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_352_setPixel32,"lime._internal.graphics.ImageCanvasUtil","setPixel32",0x94a717b4,"lime._internal.graphics.ImageCanvasUtil.setPixel32","lime/_internal/graphics/ImageCanvasUtil.hx",352,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_359_setPixels,"lime._internal.graphics.ImageCanvasUtil","setPixels",0x6b6dcefe,"lime._internal.graphics.ImageCanvasUtil.setPixels","lime/_internal/graphics/ImageCanvasUtil.hx",359,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_367_sync,"lime._internal.graphics.ImageCanvasUtil","sync",0x0d995a2c,"lime._internal.graphics.ImageCanvasUtil.sync","lime/_internal/graphics/ImageCanvasUtil.hx",367,0x04a6dce0)
namespace lime{
namespace _internal{
namespace graphics{
...
HXDLIN( 226)		int b;
HXDLIN( 226)		int a;
HXLINE( 228)		if ((format == 1)) {
HXLINE( 230)			r = ((color >> 16) & 255);
HXLINE( 231)			g = ((color >> 8) & 255);
HXLINE( 232)			b = (color & 255);
HXLINE( 233)			if (image->get_transparent()) {
HXLINE( 233)				a = ((color >> 24) & 255);
            			}
            			else {
HXLINE( 233)				a = 255;
            			}
...
HXLINE( 237)			r = ((color >> 24) & 255);
HXLINE( 238)			g = ((color >> 16) & 255);
HXLINE( 239)			b = ((color >> 8) & 255);
HXLINE( 240)			if (image->get_transparent()) {
HXLINE( 240)				a = (color & 255);
            			}
            			else {
HXLINE( 240)				a = 255;
            			}
...
HXDLIN( 243)		if ((rect->x == 0)) {
HXLINE( 243)			_hx_tmp2 = (rect->y == 0);
            		}
            		else {
HXLINE( 243)			_hx_tmp2 = false;
            		}
HXDLIN( 243)		if (_hx_tmp2) {
HXLINE( 243)			_hx_tmp1 = (rect->width == image->width);
            		}
            		else {
HXLINE( 243)			_hx_tmp1 = false;
            		}
HXDLIN( 243)		if (_hx_tmp1) {
HXLINE( 243)			_hx_tmp = (rect->height == image->height);
            		}
            		else {
...
HXDLIN( 245)			if (image->get_transparent()) {
HXLINE( 245)				_hx_tmp3 = (a == 0);
            			}
            			else {
HXLINE( 245)				_hx_tmp3 = false;
            			}
HXDLIN( 245)			if (_hx_tmp3) {
HXLINE( 247)				image->buffer->_hx___srcCanvas->__SetField(HX_("width",06,b6,62,ca),image->buffer->width,::hx::paccDynamic);
HXLINE( 248)				return;
            			}
            		}
HXLINE( 252)		if ((a < 255)) {
HXLINE( 254)			image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),::hx::paccDynamic)((rect->x + image->offsetX),(rect->y + image->offsetY),(rect->width + image->offsetX),(rect->height + image->offsetY));
            		}
HXLINE( 257)		if ((a > 0)) {
HXLINE( 259)			image->buffer->_hx___srcContext->__SetField(HX_("fillStyle",ae,cb,c4,52),((((((((HX_("rgba(",f4,cc,0d,e8) + r) + HX_(", ",74,26,00,00)) + g) + HX_(", ",74,26,00,00)) + b) + HX_(", ",74,26,00,00)) + (( (Float)(a) ) / ( (Float)(255) ))) + HX_(")",29,00,00,00)),::hx::paccDynamic);
HXLINE( 260)			image->buffer->_hx___srcContext->__Field(HX_("fillRect",47,45,b9,6c),::hx::paccDynamic)((rect->x + image->offsetX),(rect->y + image->offsetY),(rect->width + image->offsetX),(rect->height + image->offsetY));
            		}
HXLINE( 263)		image->dirty = true;
HXLINE( 264)		image->version++;
            	}
...
void ImageCanvasUtil_obj::floodFill( ::lime::graphics::Image image,int x,int y,int color,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_268_floodFill)
HXLINE( 269)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 271)		::lime::_internal::graphics::ImageDataUtil_obj::floodFill(image,x,y,color,format);
            	}
...
int ImageCanvasUtil_obj::getPixel( ::lime::graphics::Image image,int x,int y,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_275_getPixel)
HXLINE( 276)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 278)		return ::lime::_internal::graphics::ImageDataUtil_obj::getPixel(image,x,y,format);
            	}
...
int ImageCanvasUtil_obj::getPixel32( ::lime::graphics::Image image,int x,int y,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_282_getPixel32)
HXLINE( 283)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 285)		return ::lime::_internal::graphics::ImageDataUtil_obj::getPixel32(image,x,y,format);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(ImageCanvasUtil_obj,getPixel32,return )
 ...
 ::haxe::io::Bytes ImageCanvasUtil_obj::getPixels( ::lime::graphics::Image image, ::lime::math::Rectangle rect,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_289_getPixels)
HXLINE( 290)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 292)		return ::lime::_internal::graphics::ImageDataUtil_obj::getPixels(image,rect,format);
            	}
...
void ImageCanvasUtil_obj::merge( ::lime::graphics::Image image, ::lime::graphics::Image sourceImage, ::lime::math::Rectangle sourceRect, ::lime::math::Vector2 destPoint,int redMultiplier,int greenMultiplier,int blueMultiplier,int alphaMultiplier){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_297_merge)
HXLINE( 298)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(sourceImage,null());
HXLINE( 299)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 301)		::lime::_internal::graphics::ImageDataUtil_obj::merge(image,sourceImage,sourceRect,destPoint,redMultiplier,greenMultiplier,blueMultiplier,alphaMultiplier);
            	}
...
void ImageCanvasUtil_obj::resize( ::lime::graphics::Image image,int newWidth,int newHeight){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_305_resize)
HXLINE( 306)		 ::lime::graphics::ImageBuffer buffer = image->buffer;
HXLINE( 308)		if (::hx::IsNull( buffer->_hx___srcCanvas )) {
HXLINE( 310)			::lime::_internal::graphics::ImageCanvasUtil_obj::createCanvas(image,newWidth,newHeight);
HXLINE( 311)			 ::Dynamic buffer1 =  ::Dynamic(buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),::hx::paccDynamic));
HXDLIN( 311)			buffer1(buffer->get_src(),0,0,newWidth,newHeight);
            		}
            		else {
HXLINE( 315)			::lime::_internal::graphics::ImageCanvasUtil_obj::convertToCanvas(image,true);
HXLINE( 316)			 ::Dynamic sourceCanvas = buffer->_hx___srcCanvas;
HXLINE( 317)			buffer->_hx___srcCanvas = null();
HXLINE( 318)			::lime::_internal::graphics::ImageCanvasUtil_obj::createCanvas(image,newWidth,newHeight);
HXLINE( 319)			buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),::hx::paccDynamic)(sourceCanvas,0,0,newWidth,newHeight);
            		}
HXLINE( 322)		buffer->_hx___srcImageData = null();
HXLINE( 323)		buffer->data = null();
HXLINE( 325)		image->dirty = true;
HXLINE( 326)		image->version++;
            	}
...
void ImageCanvasUtil_obj::scroll( ::lime::graphics::Image image,int x,int y){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_330_scroll)
HXLINE( 331)		bool _hx_tmp;
HXDLIN( 331)		if ((::hx::Mod(x,image->width) == 0)) {
HXLINE( 331)			_hx_tmp = (::hx::Mod(y,image->height) == 0);
            		}
            		else {
...
HXLINE( 333)		 ::lime::graphics::Image copy = image->clone();
HXLINE( 335)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToCanvas(image,true);
HXLINE( 337)		image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),::hx::paccDynamic)(x,y,image->width,image->height);
HXLINE( 338)		 ::Dynamic image1 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),::hx::paccDynamic));
HXDLIN( 338)		image1(copy->get_src(),x,y);
HXLINE( 340)		image->dirty = true;
HXLINE( 341)		image->version++;
            	}
...
void ImageCanvasUtil_obj::setPixel( ::lime::graphics::Image image,int x,int y,int color,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_345_setPixel)
HXLINE( 346)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 348)		::lime::_internal::graphics::ImageDataUtil_obj::setPixel(image,x,y,color,format);
            	}
...
void ImageCanvasUtil_obj::setPixel32( ::lime::graphics::Image image,int x,int y,int color,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_352_setPixel32)
HXLINE( 353)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 355)		::lime::_internal::graphics::ImageDataUtil_obj::setPixel32(image,x,y,color,format);
            	}
...
void ImageCanvasUtil_obj::setPixels( ::lime::graphics::Image image, ::lime::math::Rectangle rect, ::lime::utils::BytePointerData bytePointer,int format, ::lime::_hx_system::Endian endian){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_359_setPixels)
HXLINE( 360)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToData(image,null());
HXLINE( 362)		::lime::_internal::graphics::ImageDataUtil_obj::setPixels(image,rect,bytePointer,format,endian);
            	}
...
void ImageCanvasUtil_obj::sync( ::lime::graphics::Image image,bool clear){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_367_sync)
HXDLIN( 367)		if (::hx::IsNull( image )) {
HXDLIN( 367)			return;
            		}
            	}

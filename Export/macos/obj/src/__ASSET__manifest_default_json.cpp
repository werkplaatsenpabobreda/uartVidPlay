...
HX_DEFINE_STACK_FRAME(_hx_pos_47f1ac2ead05c009_51_new,"__ASSET__manifest_default_json","new",0x8da5bf98,"__ASSET__manifest_default_json.new","lime/_internal/macros/AssetsMacro.hx",51,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_47f1ac2ead05c009_156_boot,"__ASSET__manifest_default_json","boot",0x5b7ae5fa,"__ASSET__manifest_default_json.boot","lime/_internal/macros/AssetsMacro.hx",156,0xc651f030)

void __ASSET__manifest_default_json_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_47f1ac2ead05c009_51_new)
HXLINE(  52)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET__:file___ASSET__manifest_default_json",1f,29,36,ad));
...
{
{
            	HX_STACKFRAME(&_hx_pos_47f1ac2ead05c009_156_boot)
HXDLIN( 156)		resourceName = HX_("__ASSET__:file___ASSET__manifest_default_json",1f,29,36,ad);
            	}
}

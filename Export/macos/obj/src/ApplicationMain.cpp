...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("UartVidPlay",d7,a4,61,3d),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Avans",f1,dc,54,bb));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("UartVidPlay",d7,a4,61,3d));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("UartVidPlay",d7,a4,61,3d));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("nl.avans.uartvidplay",ea,e1,01,be));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("UartVidPlay",d7,a4,61,3d))

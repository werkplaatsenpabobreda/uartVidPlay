...
HX_DECLARE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_945_new)
...
HXLINE( 946)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 947)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE( 948)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->width = width;
HXLINE( 949)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->height = height;
HXLINE( 950)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->x = x;
HXLINE( 951)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->y = y;
            	}

...
HX_DECLARE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_794_new)
...
HXLINE( 795)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 796)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->windowID = 0;
HXLINE( 797)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->x = x;
HXLINE( 798)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->y = y;
HXLINE( 799)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->button = button;
HXLINE( 800)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 801)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementY = movementY;
HXLINE( 802)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->clickCount = clickCount;
            	}

...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_879_new)
...
HXLINE( 880)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 881)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE( 882)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->text = text;
HXLINE( 883)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE( 884)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}

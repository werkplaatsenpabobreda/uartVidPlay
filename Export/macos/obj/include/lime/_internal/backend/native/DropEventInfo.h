...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_672_new)
...
HXLINE( 673)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 674)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}

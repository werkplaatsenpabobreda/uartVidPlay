...
HX_DECLARE_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_697_new)
...
HXLINE( 698)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 699)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->id = id;
HXLINE( 700)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->button = button;
HXLINE( 701)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 702)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axisValue = value;
            	}

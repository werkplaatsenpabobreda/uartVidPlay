...
HX_DECLARE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_850_new)
...
HXLINE( 851)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 852)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->id = id;
HXLINE( 853)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->x = x;
HXLINE( 854)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->y = y;
HXLINE( 855)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->z = z;
            	}

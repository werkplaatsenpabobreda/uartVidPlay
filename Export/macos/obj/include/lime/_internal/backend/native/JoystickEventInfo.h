...
HX_DECLARE_STACK_FRAME(_hx_pos_21cd05885e6e0032_730_new)
...
HXLINE( 731)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 732)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->id = id;
HXLINE( 733)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->index = index;
HXLINE( 734)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->eventValue = value;
HXLINE( 735)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->x = x;
HXLINE( 736)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->y = y;
            	}
